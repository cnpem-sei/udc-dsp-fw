...
#define MAX_REF					1.2		    // Valor máximo da referência de corrente na carga [A]
#define MIN_REF					-1.2	    // Valor mínimo da referência de corrente na carga [A]
#define MAX_LOAD				1.5		    // Limite de corrente na carga para interlock [A]
...
#define KP						0.65        // Teste da Amanda (LNLS/XPD)   //2.8
#define KI						770.0       // Ro = 1 Ohm, Lo = 507 uH      //470
