...
#define MAX_REF					990.0//200.0		// Valor mï¿½ximo da referï¿½ncia de corrente na carga [A]
#define MIN_REF					-990.0//-200.0		// Valor mï¿½nimo da referï¿½ncia de corrente na carga [A]
