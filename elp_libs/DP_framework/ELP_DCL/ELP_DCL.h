...
typedef volatile struct
{
    /*Uint16          num_rows;
    Uint16          num_columns;
    volatile float  matrix[NUM_MAX_MATRIX_SIZE][NUM_MAX_MATRIX_SIZE];*/
    matrix_t        matrix;
    volatile float  *in;
    volatile float  *out;
} tELP_MultiplyMatrix;
...
extern void Init_ELP_MultiplyMatrix(tELP_MultiplyMatrix *ptr_mtx, Uint16 num_rows, Uint16 num_columns,
