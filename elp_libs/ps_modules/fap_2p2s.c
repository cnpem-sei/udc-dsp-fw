...
#define MAX_I_ARMS_DIFF                         g_ipc_mtoc.analog_vars.max[1]
...
#define MAX_V_DCLINK                            g_ipc_mtoc.analog_vars.max[6]
#define MIN_V_DCLINK                            g_ipc_mtoc.analog_vars.min[6]

#define TIMEOUT_DCLINK_CONTACTOR_CLOSED_MS      g_ipc_mtoc.analog_vars.max[7]
#define TIMEOUT_DCLINK_CONTACTOR_OPENED_MS      g_ipc_mtoc.analog_vars.max[8]

#define NETSIGNAL_ELEM_CTOM_BUF                 g_ipc_mtoc.analog_vars.max[9]
#define NETSIGNAL_ELEM_MTOC_BUF                 g_ipc_mtoc.analog_vars.min[9]
